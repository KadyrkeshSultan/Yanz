...
namespace Yanz.Data
{
    public class FolderContext
    {
        ...
        public FolderContext(ApplicationDbContext dbContext)
        {
            db = dbContext;
        }
        ...
        /// <param name="folderId"></param>
        /// <returns></returns>
        public List<QuestionSet> GetQuestionSets(string folderId)
        {
            return db.QuestionSets.Include(q => q.Questions).Where(q => q.FolderId == folderId).ToList();
        }
